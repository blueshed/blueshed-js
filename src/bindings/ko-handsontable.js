(function (factory) {
    if (typeof define === "function" && define.amd) {
        ...
        define(["knockout", "jquery", "handsontable","numeral"], factory);
    } else {
            ...
            mappedColumns = $.map(columns, function (propertyName, index) {
                return {data: (function (attr) {
                    return function (row, value) {
                     ...
                     renderer:(function (attr) {
                     if (propertyName.renderer){
                         return propertyName.renderer;
                         }})(),
                     readOnly:(function (attr) {
    ...
    ko.bindingHandlers.handsontable = {
        init: function (element, valueAccessor, allBindingsAccessor, data, context) {
            ...
            //$element.find("table").addClass("table table-condensed table-hover");
            if(options.panel){
                options.panel($element.handsontable("getInstance"));
